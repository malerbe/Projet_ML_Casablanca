...
if __name__ == "__main__":
    ...
    for params in param_grid:
        ...
        model = UNET2(in_channels=1, out_channels=1, features=params["UNET_FEATURES"], batch_norm=params["BATCH_NORM"], kernel_pool_size=params["KERNEL_POOL_SIZE"], conv_kernel_size=params["CONV_KERNEL_SIZE"])
