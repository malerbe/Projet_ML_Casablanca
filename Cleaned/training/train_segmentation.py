...
def get_datasets(train_imgs_dir, train_masks_dir, eval_imgs_dir, eval_masks_dir, **params):
    train_transforms, test_transforms = preprocessing.get_transformations(img_size=params["IMAGE_WIDTH_HEIGHT"][0])

    train_dataset = datasets.TumorSegmentationDataset(train_imgs_dir, train_masks_dir, train_transforms)
    test_dataset = datasets.TumorSegmentationDataset(eval_imgs_dir, eval_masks_dir, test_transforms)
...
def train_unet(**params):
    ...
    eval_imgs_dir = params["EVAL_IMGS_DIR"]
    eval_masks_dir = params["EVAL_MASKS_DIR"]
    ...
    train_dataset, test_dataset = get_datasets(train_imgs_dir, train_masks_dir, eval_imgs_dir, eval_masks_dir, **params)
